...
import { renderFilterGanresBackdrop } from './renderFilterGanresBackdrop';
...
//=============================end===========================================
//  refs.LibraryFromLocalStorage.map(element => {
//    console.log('element.genre_ids', element.genre_ids);
//    console.log('genres', element);

//    if (
//      element.genre_ids.includes(ganre) ||
//      element.genres.id.includes(ganre)
//    ) {
//      filterArrayMovies.push(element);
//    }
//  });
