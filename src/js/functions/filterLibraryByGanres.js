...
import { renderLoadMoreCard } from './renderLoadMoreCard';
...
const arraGanres = refs.LibraryFromLocalStorage.map(arr => arr.genres);
console.log(arraGanres);
const allGanres = arraGanres.map((...arr) => arr.name);
console.log(allGanres);

//console.log(libraryListAllGanre(refs.LibraryFromLocalStorage));
...
//////=====================Главная функция: По Клику Получаем жанр и трансформируем его в айди==================================
